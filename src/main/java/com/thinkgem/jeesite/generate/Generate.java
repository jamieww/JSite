...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String packageName = "com.cyclone.jsite.modules";
		
		String moduleName = "ifolder";			// 模块名，例：sys
		String subModuleName = "";				// 子模块名（可选） 
		String className = "file";			// 类名，例：user
		String classAuthor = "Jame";		// 类作者，例：ThinkGem
		String functionName = "智慧夹";			// 功能名，例：用户
